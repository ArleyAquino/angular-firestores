...
@Component({
  selector: 'app-carucel-formal-vestido',
  templateUrl: './carucel-formal-vestido.component.html',
  styleUrls: ['./carucel-formal-vestido.component.css']
})
export class CarucelFormalVestidoComponent implements OnInit {
