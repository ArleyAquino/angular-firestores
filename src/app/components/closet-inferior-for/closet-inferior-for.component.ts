...
export class ClosetInferiorForComponent implements OnInit {
  ...
  public subirArchivo() {
    ...
    let referencia = this.firebaseStorage.referenciaFormalInferiorCloudStorage(this.nombreArchivo);
    let tarea = this.firebaseStorage.tareaFormalInferiorCloudStorage(this.nombreArchivo, archivo);
