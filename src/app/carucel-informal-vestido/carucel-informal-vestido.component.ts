...
@Component({
  selector: 'app-carucel-informal-vestido',
  templateUrl: './carucel-informal-vestido.component.html',
  styleUrls: ['./carucel-informal-vestido.component.css']
})
export class CarucelInformalVestidoComponent implements OnInit {
