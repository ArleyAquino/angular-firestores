...
@Component({
  selector: 'app-carucel-formal',
  templateUrl: './carucel-formal.component.html',
  styleUrls: ['./carucel-formal.component.css']
})
export class CarucelFormalComponent implements OnInit {
